...
export class PokemonService {
    ...
    return this.http
      ...
      .pipe(
        catchError((error: any, caught) =>
          this.handleError(error, caught.subscribe()),
        ),
      );
  }
  ...
  addNewPokemon(pokemon: Pokemon): Observable<Pokemon> {
    ...
    return this.http
      ...
      .pipe(catchError((error: Error) => this.handleError(error)));
  }
  ...
  updatePokemonInfo(pokemon: Pokemon): Observable<null> {
    ...
    return this.http
      .put("api/pokemons", pokemon, httpOptions)
      .pipe(catchError((error: Error) => this.handleError(error)));
  }
  ...
  deletePokemon(id: number): Observable<null> {
    ...
    return this.http
      .delete(`api/pokemons/${id}`, httpOptions)
      .pipe(catchError((error: Error) => this.handleError(error)));
  }
  ...
  private handleError(
    error: Error,
    errorValue: any = "Une erreur inconnue s'est produite !",
  ) {
